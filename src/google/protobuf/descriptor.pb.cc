...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 236, 243, sizeof(EnumValueOptions)},
...
void protobuf_AddDesc_google_2fprotobuf_2fdescriptor_2eproto_impl() {
  ...
  static const char descriptor[] = {
      ...
      "descriptor;descriptor\242\002\003GPB\252\002\032Google.Pro"
      "tobuf.Reflection"
  };
...
// @@protoc_insertion_point(message_clear_start:google.protobuf.EnumValueOptions)
  ...
  uninterpreted_option_.Clear();
  if (has_scoped_alias()) {
    GOOGLE_DCHECK(!scoped_alias_.IsDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited()));
    (*scoped_alias_.UnsafeRawStringPointer())->clear();
  }
  deprecated_ = false;
  _has_bits_.Clear();
  _internal_metadata_.Clear();
...
const ::std::string& EnumValueOptions::scoped_alias() const {
  ...
  return scoped_alias_.GetNoArena();
}
...
#if LANG_CXX11
void EnumValueOptions::set_scoped_alias(::std::string&& value) {
  set_has_scoped_alias();
  scoped_alias_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
